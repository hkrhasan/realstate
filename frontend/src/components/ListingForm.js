...
const ListingForm = (props) => {
    ...
    const { sale_type, price, bedrooms, home_type, bathrooms, sqft, days_passed, has_photos, open_house, keywords } = formData;
    ...
    const onSubmit = e => {
        ...
        axios.post(`${process.env.REACT_APP_API_URL}/api/listings/search`, { sale_type, price, bedrooms, home_type, bathrooms, sqft, days_passed, has_photos, open_house, keywords }, config)
        .then(res => {
            setLoading(false);
        ...
        <form className='listingform' onSubmit={e => onSubmit(e)}>
            <div className='row'>
                ...
                <div className='col-1-of-6'>
                    ...
                    <div className='listingform__section'>
                        <label className='listingform__label' htmlFor='days_passed'>Days Listed</label>
                        <select className='listingform__select' name='days_passed' onChange={e => onChange(e)} value={days_passed}>
